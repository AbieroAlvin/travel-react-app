...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2 '>
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 py-6 px-4 border-gray-600'>
            <div>
            ...
            <div className='py-8 cols-span-2 md:pt-2'>
                ...
                <form className='flex flex-col sm:flex-row '>
                    ...
                    <button className='p-2 mb-4 rounded-md' type='submit'>Subscribe</button>
                </form>
            </div>
        </div>
